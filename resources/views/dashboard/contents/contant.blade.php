        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                    ...
                    <a href="#" class="small-box-footer">لمزيد من التفاصيل<i
                    ...
                    <div class="card-body">
                        <ul class="todo-list ui-sortable" data-widget="todo-list">
                            ...
                            <li>
                                ...
                                <!-- todo text -->
                                <a href="{{ route('expenses') }}"><span class="text">المصروفات</span></a>
                                <!-- Emphasis label -->
                                {{-- <small class="badge badge-danger"><i class="far fa-clock"></i> 2 mins</small> --}}
                                <!-- General tools such as edit or delete-->
                                {{-- <div class="tools">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="picker-switch" data-action="pickerSwitch"
                                                                colspan="5" title="Select Month">September 2023
                                                            </th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-action="selectDay" data-day="09/30/2023"
                                                                class="day active today weekend">30</td>
                                                        </tr>
                                                        <tr>
